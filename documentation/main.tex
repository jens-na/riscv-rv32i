...
\include{Chapters/FPGA} %FPGA
\include{Chapters/VHDL} %VHDL
\include{Chapters/RISC} %RISC
\include{Chapters/Umsetzung} %Umsetzung
\include{Chapters/Herangehensweise} %Herangehensweise
\include{Chapters/Probleme} %Probleme
\include{Chapters/Ergebnis}
%\include{Chapters/Dokumentation} %Dokumentation
...
\include{Appendices/schaltplan}
\include{Appendices/Maschinenbefehle}
