...
\large \textit{Dokumentation der Praktischen Tätigkeit\\ im Rahmen des Wahlprojekts Software- Hardwareschnittstellen\\ im Wintersemester 2016/1017}\\[0.3cm] % University requirement text
%\textit{im}\\[0.4cm]
...
{\large \today}\\[4cm] % Date
\includegraphics{HSRM_logo} % University/department logo - uncomment to place it
...
\include{Chapters/FPGA}
\include{Chapters/VHDL}
\include{Chapters/RISC}
\include{Chapters/Umsetzung}
\include{Chapters/Herangehensweise}
\include{Chapters/Probleme}
\include{Chapters/Dokumentation}
