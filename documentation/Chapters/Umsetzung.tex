...
Findet nun ein Speicherzugriff mit der Breite von 32-Bit auf eine Adresse statt, die nicht ausgerichtet ist, ergibt sich folgendes Problem:
Nicht alle vier Bytes des gesuchten Wortes befinden sich unter der gleichen (Wort-)Adresse im Speicher.
Um das Wort zu lesen zu können würden zwei Zugriffe benötigt, wofür man wiederum die Anzahl der Takte pro Maschinenbfehel erhöhen müsste.
Stattdessen wurde hier ein nicht ausgerichteter Speicherzugriff unterbunden.~\ref{}
