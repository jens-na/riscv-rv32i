...
bis auf \code{work/} in einem Versionskontrollsystem abgelegt werden:
...
Entwicklung der Load-Befehle wie \code{lw, lb, lh} beinhaltet.
...
des Registers \code{a0} (Return-Register nach Programmierkonvention) mit den LEDs auf dem FPGA verbunden. Es
